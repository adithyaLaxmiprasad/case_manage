...
<body>
    ...
    <form action="lawyer_signup.php" method="post" class="border p-3">
        <div class="container">
            <h1 class="text-center">Sign Up for Lawyers</h1>
            <p class="text-center">Please fill in this form to create an account.</p>
            <hr>

            <div class="form-group">
                <label for="name"><b>First Name</b></label>
                <input type="text" placeholder="First Name" name="lawyer-firstname" class="form-control" required>
            </div>

            <div class="form-group">
                <label for="name"><b>Last Name</b></label>
                <input type="text" placeholder="Last Name" name="lawyer-lastname" class="form-control" required>
            </div>

            <div class="form-group">
                <label for="email"><b>Email</b></label>
                <input type="text" placeholder="Enter Email" name="lawyer-email" class="form-control" required>
            </div>

            <div class="form-group">
                <label for="psw"><b>Password</b></label>
                <input type="password" placeholder="Enter Password" name="lawyer-password" id="pass" class="form-control" required>
            </div>
            ...
            <div class="clearfix">
                ...
                <button type="submit" name="lawyer-signup" class="btn btn-primary">Sign Up</button>
            </div>
